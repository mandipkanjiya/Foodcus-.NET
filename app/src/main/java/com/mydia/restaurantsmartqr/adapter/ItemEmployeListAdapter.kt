...
class ItemEmployeListAdapter(context: Context,private var incomingOrderList:List<EmployeItem>) :  RecyclerView.Adapter<ItemEmployeListAdapter.ViewHolder>() {
    var context: Context
    ...
    interface OnItemClickListener {
        fun onItemClick(datum: EmployeItem?, pos: Int)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvOrderId.text = incomingData.cEmpName
