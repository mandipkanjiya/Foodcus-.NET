...
class ItemTableListAadapter(context: Context,private var incomingOrderList:List<TableList>) :  RecyclerView.Adapter<ItemTableListAadapter.ViewHolder>() {
    var context: Context
    ...
    interface OnItemClickListener {
        fun onItemClick(datum: TableList?, pos: Int)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding: ItemTableListBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.item_table_list, parent, false
        )
    ...
    inner class ViewHolder(binding: ItemTableListBinding) :
        RecyclerView.ViewHolder(binding.root) {
        var binding: ItemTableListBinding = binding
    }
